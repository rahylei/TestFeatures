    ...
    <x-kuijet.auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="grid gap-6">
                <!-- Name -->
                <div class="space-y-2">
                    <x-kuijet.label for="name" :value="__('Name')" />
                    <x-kuijet.input-with-icon-wrapper>
                        <x-slot name="icon">
                            <x-heroicon-o-user aria-hidden="true" class="w-5 h-5" />
                        </x-slot>
                        <x-kuijet.input withicon id="name" class="block w-full" type="text" name="name" :value="old('name')"
                ...
                <div class="space-y-2">
                    ...
                    <x-kuijet.input-with-icon-wrapper>
                        ...
                        <x-kuijet.input withicon id="password" class="block w-full" type="password" name="password" required
                ...
                <div class="space-y-2">
                    ...
                    <x-kuijet.input-with-icon-wrapper>
                        ...
                        <x-kuijet.input withicon id="password_confirmation" class="block w-full" type="password"
                    ...
                    @if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())
                        <div class="space-y-2">
                            <x-kuijet.label for="terms">
                                <div class="flex items-center">
                                    <x-kuijet.checkbox name="terms" id="terms"/>
                ...
                <div>
                    <x-kuijet.button class="justify-center w-full gap-2">
